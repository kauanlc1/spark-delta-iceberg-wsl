...
<pre class="cython line score-26" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">051</span>:     def __cinit__(self, input_contents: bytes) -&gt; None:</pre>
...
</pre><pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">052</span>:         self._size = len(input_contents)</pre>
...
<pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">055</span>:         self._data = &lt;unsigned char *&gt; PyMem_Malloc(self._size * sizeof(char))</pre>
...
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">056</span>:         if not self._data:</pre>
<pre class='cython code score-0 '>  __pyx_t_2 = (!(__pyx_v_self-&gt;_data != 0));
  if (unlikely(__pyx_t_2)) {
/* … */
  }
</pre><pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">057</span>:             raise MemoryError()</pre>
...
</pre><pre class="cython line score-7" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">058</span>:         cdef const unsigned char *input_as_array = input_contents</pre>
...
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">059</span>:         memcpy(self._data, input_as_array, self._size)</pre>
<pre class='cython code score-0 '>  (void)(memcpy(__pyx_v_self-&gt;_data, __pyx_v_input_as_array, __pyx_v_self-&gt;_size));
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">060</span>:         self._end = self._data + self._size</pre>
<pre class='cython code score-0 '>  __pyx_v_self-&gt;_end = (__pyx_v_self-&gt;_data + __pyx_v_self-&gt;_size);
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">061</span>:         self._current = self._data</pre>
...
<pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">063</span>:     def __dealloc__(self):</pre>
...
</pre><pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">064</span>:         PyMem_Free(self._data)</pre>
...
<pre class="cython line score-26" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">066</span>:     cpdef unsigned int tell(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_5tell, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_tell, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[0]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 66, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_tell, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 66, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre><pre class="cython line score-0">&#xA0;<span class="">067</span>:         """Return the current stream position."""</pre>
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">068</span>:         return self._current - self._data</pre>
...
<pre class="cython line score-57" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">070</span>:     cpdef bytes read(self, n: int):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(1);<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_n, __pyx_mstate_global-&gt;__pyx_n_u_int) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 70, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_7read, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[1]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 70, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-0">&#xA0;<span class="">071</span>:         """Read n bytes."""</pre>
<pre class="cython line score-8" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">072</span>:         if n &lt; 0:</pre>
...
</pre><pre class="cython line score-18" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">073</span>:             raise ValueError(f"Requested {n} bytes to read, expected positive integer.")</pre>
<pre class='cython code score-18 '>    __pyx_t_3 = NULL;
    ...
    __pyx_t_5 = <span class='pyx_c_api'>__Pyx_PyObject_FormatSimple</span>(__pyx_v_n, __pyx_mstate_global-&gt;__pyx_empty_unicode);<span class='error_goto'> if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_5);
    ...
    if (unlikely(!__pyx_t_7)) <span class='error_goto'>__PYX_ERR(0, 73, __pyx_L1_error)</span>
...
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">074</span>:         cdef const unsigned char *r = self._current</pre>
<pre class='cython code score-0 '>  __pyx_t_9 = __pyx_v_self-&gt;_current;
  __pyx_v_r = __pyx_t_9;
</pre><pre class="cython line score-7" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">075</span>:         self._current += n</pre>
<pre class='cython code score-7 '>  __pyx_t_10 = <span class='pyx_c_api'>__Pyx_PyIndex_AsSsize_t</span>(__pyx_v_n); if (unlikely((__pyx_t_10 == (Py_ssize_t)-1) &amp;&amp; <span class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 75, __pyx_L1_error)</span>
  __pyx_v_self-&gt;_current = (__pyx_v_self-&gt;_current + __pyx_t_10);
</pre><pre class="cython line score-12" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">076</span>:         return r[0:n]</pre>
<pre class='cython code score-12 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  ...
  if (__pyx_t_2) {
    ...
    __pyx_t_12 = <span class='pyx_c_api'>__Pyx_PyIndex_AsSsize_t</span>(__pyx_t_11); if (unlikely((__pyx_t_12 == (Py_ssize_t)-1) &amp;&amp; <span class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 76, __pyx_L1_error)</span>
    __pyx_t_10 = __pyx_t_12;
  }
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_1 = <span class='pyx_c_api'>__Pyx_PyBytes_FromStringAndSize</span>(((char const *)__pyx_v_r) + 0, __pyx_t_10 - 0);<span class='error_goto'> if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 76, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_1);
  __pyx_r = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;
  goto __pyx_L0;
</pre><pre class="cython line score-0">&#xA0;<span class="">077</span>: </pre>
<pre class="cython line score-33" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">078</span>:     def read_boolean(self) -&gt; bool:</pre>
...
/* … */
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(1);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 78, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_bool) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 78, __pyx_L1_error)</span>
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_9read_boolean, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_boolean, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[2]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_3, __pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_boolean, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 78, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">084</span>:         self._current += 1;</pre>
<pre class='cython code score-0 '>  __pyx_v_self-&gt;_current = (__pyx_v_self-&gt;_current + 1);
</pre><pre class="cython line score-3" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">085</span>:         return self._current[-1] != 0</pre>
...
<pre class="cython line score-29" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">087</span>:     cpdef inline int64_t read_int(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_11read_int, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_int, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[3]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 87, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_int, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 87, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">093</span>:         if self._current &gt;= self._end:</pre>
<pre class='cython code score-0 '>  __pyx_t_1 = (__pyx_v_self-&gt;_current &gt;= __pyx_v_self-&gt;_end);
  if (unlikely(__pyx_t_1)) {
/* … */
  }
</pre><pre class="cython line score-8" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">094</span>:           raise EOFError(f"EOF: read 1 bytes")</pre>
...
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">095</span>:         decode_zigzag_ints(&amp;self._current, 1, &amp;result)</pre>
<pre class='cython code score-0 '>  decode_zigzag_ints((&amp;__pyx_v_self-&gt;_current), 1, (&amp;__pyx_v_result));
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">096</span>:         return result</pre>
<pre class='cython code score-0 '>  __pyx_r = __pyx_v_result;
  goto __pyx_L0;
</pre><pre class="cython line score-0">&#xA0;<span class="">097</span>: </pre>
<pre class="cython line score-51" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">098</span>:     def read_ints(self, count: int) -&gt; array.array[int]:</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(2);<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 98, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_count, __pyx_mstate_global-&gt;__pyx_n_u_int) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 98, __pyx_L1_error)</span>
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_kp_u_array_array_int) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 98, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_13read_ints, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_ints, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[4]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 98, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_ints, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 98, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-0">&#xA0;<span class="">099</span>:         """Reads a list of integers."""</pre>
<pre class="cython line score-9" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">100</span>:         newarray = array.clone(unsigned_long_long_array_template, count, zero=False)</pre>
<pre class='cython code score-9 '>  __pyx_t_1 = ((PyObject *)__pyx_v_9pyiceberg_4avro_12decoder_fast_unsigned_long_long_array_template);
  ...
  __pyx_t_3 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">101</span>:         if self._current &gt;= self._end:</pre>
<pre class='cython code score-0 '>  __pyx_t_4 = (__pyx_v_self-&gt;_current &gt;= __pyx_v_self-&gt;_end);
  if (unlikely(__pyx_t_4)) {
/* … */
  }
</pre><pre class="cython line score-8" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">102</span>:           raise EOFError(f"EOF: read 1 bytes")</pre>
...
</pre><pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">103</span>:         decode_zigzag_ints(&amp;self._current, count, &lt;uint64_t *&gt;newarray.data.as_ulonglongs)</pre>
<pre class='cython code score-5 '>  __pyx_t_7 = __Pyx_PyLong_As_uint64_t(__pyx_v_count); if (unlikely((__pyx_t_7 == ((uint64_t)-1)) &amp;&amp; <span class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 103, __pyx_L1_error)</span>
  decode_zigzag_ints((&amp;__pyx_v_self-&gt;_current), __pyx_t_7, ((uint64_t *)__pyx_v_newarray-&gt;data.as_ulonglongs));
</pre><pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">104</span>:         return newarray</pre>
...
<pre class="cython line score-64" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">106</span>:     cpdef void read_int_bytes_dict(self, count: int, dest: Dict[int, bytes]):</pre>
...
/* … */
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(2);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 106, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_count, __pyx_mstate_global-&gt;__pyx_n_u_int) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 106, __pyx_L1_error)</span>
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_dest, __pyx_mstate_global-&gt;__pyx_kp_u_Dict_int_bytes) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 106, __pyx_L1_error)</span>
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_15read_int_bytes_dict, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_int_byt, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[5]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 106, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_3, __pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_int_bytes_dict, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 106, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">109</span>:         if self._current &gt;= self._end:</pre>
<pre class='cython code score-0 '>  __pyx_t_1 = (__pyx_v_self-&gt;_current &gt;= __pyx_v_self-&gt;_end);
  if (unlikely(__pyx_t_1)) {
/* … */
  }
</pre><pre class="cython line score-8" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">110</span>:           raise EOFError(f"EOF: read 1 bytes")</pre>
<pre class='cython code score-8 '>    __pyx_t_3 = NULL;
    <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_builtin_EOFError);
    __pyx_t_4 = __pyx_builtin_EOFError; 
    __pyx_t_5 = 1;
...
<pre class="cython line score-61" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">112</span>:         for _ in range(count):</pre>
<pre class='cython code score-61 '>  __pyx_t_4 = NULL;
  ...
  if (likely(<span class='py_c_api'>PyList_CheckExact</span>(__pyx_t_2)) || <span class='py_c_api'>PyTuple_CheckExact</span>(__pyx_t_2)) {
    ...
    __pyx_t_6 = -1; __pyx_t_3 = <span class='py_c_api'>PyObject_GetIter</span>(__pyx_t_2);<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 112, __pyx_L1_error)</span>
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
    __pyx_t_7 = (CYTHON_COMPILING_IN_LIMITED_API) ? PyIter_Next : <span class='pyx_c_api'>__Pyx_PyObject_GetIterNextFunc</span>(__pyx_t_3);<span class='error_goto'> if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 112, __pyx_L1_error)</span>
  }
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
  for (;;) {
    if (likely(!__pyx_t_7)) {
      if (likely(<span class='py_c_api'>PyList_CheckExact</span>(__pyx_t_3))) {
        {
          ...
          #if !CYTHON_ASSUME_SAFE_SIZE
          if (unlikely((__pyx_temp &lt; 0))) <span class='error_goto'>__PYX_ERR(0, 112, __pyx_L1_error)</span>
          #endif
    ...
    <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
    if (!(likely(<span class='py_c_api'>PyLong_CheckExact</span>(__pyx_t_2))||((__pyx_t_2) == Py_None) || <span class='pyx_c_api'>__Pyx_RaiseUnexpectedTypeError</span>("int", __pyx_t_2))) <span class='error_goto'>__PYX_ERR(0, 112, __pyx_L1_error)</span>
    <span class='pyx_macro_api'>__Pyx_XDECREF_SET</span>(__pyx_v__, ((PyObject*)__pyx_t_2));
    __pyx_t_2 = 0;
/* … */
  }
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">113</span>:           decode_zigzag_ints(&amp;self._current, 2, &lt;uint64_t *&gt;&amp;result)</pre>
<pre class='cython code score-0 '>    decode_zigzag_ints((&amp;__pyx_v_self-&gt;_current), 2, ((uint64_t *)(&amp;__pyx_v_result)));
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">114</span>:           if result[1] &lt;= 0:</pre>
<pre class='cython code score-0 '>    __pyx_t_1 = ((__pyx_v_result[1]) &lt;= 0);
    if (__pyx_t_1) {
/* … */
      goto __pyx_L6;
    }
</pre><pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">115</span>:               dest[result[0]] = b""</pre>
<pre class='cython code score-2 '>      if (unlikely((<span class='pyx_c_api'>__Pyx_SetItemInt</span>(__pyx_v_dest, (__pyx_v_result[0]), __pyx_mstate_global-&gt;__pyx_kp_b_, uint64_t, 0, __Pyx_PyLong_From_uint64_t, 0, 0, 1, 1) &lt; 0))) <span class='error_goto'>__PYX_ERR(0, 115, __pyx_L1_error)</span>
</pre><pre class="cython line score-0">&#xA0;<span class="">116</span>:           else:</pre>
<pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">117</span>:               dest[result[0]] = self._current[0:result[1]]</pre>
<pre class='cython code score-5 '>    /*else*/ {
      ...
      <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_2);
      if (unlikely((<span class='pyx_c_api'>__Pyx_SetItemInt</span>(__pyx_v_dest, (__pyx_v_result[0]), __pyx_t_2, uint64_t, 0, __Pyx_PyLong_From_uint64_t, 0, 0, 1, 1) &lt; 0))) <span class='error_goto'>__PYX_ERR(0, 117, __pyx_L1_error)</span>
      <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_2); __pyx_t_2 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">118</span>:               self._current += result[1]</pre>
...
<pre class="cython line score-29" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">120</span>:     cpdef inline bytes read_bytes(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_17read_bytes, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_bytes, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[6]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 120, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_bytes, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 120, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">123</span>:         if self._current &gt;= self._end:</pre>
<pre class='cython code score-0 '>  __pyx_t_1 = (__pyx_v_self-&gt;_current &gt;= __pyx_v_self-&gt;_end);
  if (unlikely(__pyx_t_1)) {
/* … */
  }
</pre><pre class="cython line score-8" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">124</span>:           raise EOFError(f"EOF: read 1 bytes")</pre>
<pre class='cython code score-8 '>    __pyx_t_3 = NULL;
    <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_builtin_EOFError);
    __pyx_t_4 = __pyx_builtin_EOFError; 
    __pyx_t_5 = 1;
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">126</span>:         decode_zigzag_ints(&amp;self._current, 1, &amp;length)</pre>
...
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">128</span>:         if length &lt;= 0:</pre>
<pre class='cython code score-0 '>  __pyx_t_1 = (__pyx_v_length &lt;= 0);
  if (__pyx_t_1) {
/* … */
  }
</pre><pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">129</span>:             return b""</pre>
<pre class='cython code score-2 '>    <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
    <span class='pyx_macro_api'>__Pyx_INCREF</span>(__pyx_mstate_global-&gt;__pyx_kp_b_);
    __pyx_r = __pyx_mstate_global-&gt;__pyx_kp_b_;
    goto __pyx_L0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">130</span>:         cdef const unsigned char *r = self._current</pre>
<pre class='cython code score-0 '>  __pyx_t_6 = __pyx_v_self-&gt;_current;
  __pyx_v_r = __pyx_t_6;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">131</span>:         self._current += length</pre>
<pre class='cython code score-0 '>  __pyx_v_self-&gt;_current = (__pyx_v_self-&gt;_current + __pyx_v_length);
</pre><pre class="cython line score-3" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">132</span>:         return r[0:length]</pre>
<pre class='cython code score-3 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
...
<pre class="cython line score-35" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">134</span>:     cpdef float read_float(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_19read_float, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_float, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[7]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 134, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_float, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 134, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-31" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">141</span>:         return float(STRUCT_FLOAT.unpack(self.read(4))[0])</pre>
<pre class='cython code score-31 '>  __pyx_t_2 = NULL;
  ...
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_GetItemInt</span>(__pyx_t_1, 0, long, 1, __Pyx_PyLong_From_long, 0, 0, 1, 1);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 141, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = <span class='pyx_c_api'>__Pyx_PyObject_AsDouble</span>(__pyx_t_4); if (unlikely(__pyx_t_6 == ((double)((double)-1)) &amp;&amp; <span class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 141, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_r = __pyx_t_6;
  goto __pyx_L0;
</pre><pre class="cython line score-0">&#xA0;<span class="">142</span>: </pre>
<pre class="cython line score-35" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">143</span>:     cpdef float read_double(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_21read_double, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_double, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[8]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 143, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_double, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 143, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-31" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">150</span>:         return float(STRUCT_DOUBLE.unpack(self.read(8))[0])</pre>
<pre class='cython code score-31 '>  __pyx_t_2 = NULL;
  ...
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_GetItemInt</span>(__pyx_t_1, 0, long, 1, __Pyx_PyLong_From_long, 0, 0, 1, 1);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 150, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = <span class='pyx_c_api'>__Pyx_PyObject_AsDouble</span>(__pyx_t_4); if (unlikely(__pyx_t_6 == ((double)((double)-1)) &amp;&amp; <span class='py_c_api'>PyErr_Occurred</span>())) <span class='error_goto'>__PYX_ERR(0, 150, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_r = __pyx_t_6;
  goto __pyx_L0;
</pre><pre class="cython line score-0">&#xA0;<span class="">151</span>: </pre>
<pre class="cython line score-28" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">152</span>:     cpdef str read_utf8(self):</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_23read_utf8, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_read_utf8, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[9]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 152, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_read_utf8, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 152, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
...
<pre class="cython line score-7" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">158</span>:         return self.read_bytes().decode("utf-8")</pre>
...
<pre class="cython line score-29" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">160</span>:     def skip_int(self) -&gt; None:</pre>
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 160, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_25skip_int, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_int, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[10]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 160, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_int, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 160, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">161</span>:         skip_zigzag_int(&amp;self._current)</pre>
<pre class='cython code score-0 '>  skip_zigzag_int((&amp;__pyx_v_self-&gt;_current));
</pre><pre class="cython line score-2" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">162</span>:         return</pre>
<pre class='cython code score-2 '>  <span class='pyx_macro_api'>__Pyx_XDECREF</span>(__pyx_r);
  __pyx_r = Py_None; <span class='pyx_macro_api'>__Pyx_INCREF</span>(Py_None);
  goto __pyx_L0;
</pre><pre class="cython line score-0">&#xA0;<span class="">163</span>: </pre>
<pre class="cython line score-47" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">164</span>:     def skip(self, n: int) -&gt; None:</pre>
...
/* … */
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(2);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 164, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_n, __pyx_mstate_global-&gt;__pyx_n_u_int) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 164, __pyx_L1_error)</span>
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 164, __pyx_L1_error)</span>
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_27skip, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[11]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 164, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_3, __pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 164, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre><pre class="cython line score-7" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">165</span>:         self._current += n</pre>
...
<pre class="cython line score-30" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">167</span>:     def skip_boolean(self) -&gt; None:</pre>
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 167, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_29skip_boolean, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_boolean, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[12]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 167, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_boolean, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 167, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">168</span>:         self._current += 1</pre>
<pre class='cython code score-0 '>  __pyx_v_self-&gt;_current = (__pyx_v_self-&gt;_current + 1);
</pre><pre class="cython line score-0">&#xA0;<span class="">169</span>: </pre>
<pre class="cython line score-30" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">170</span>:     def skip_float(self) -&gt; None:</pre>
<pre class='cython code score-30 '>/* Python wrapper */
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 170, __pyx_L1_error)</span>
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_31skip_float, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_float, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[13]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 170, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_3, __pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_float, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 170, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">171</span>:         self._current += 4</pre>
...
<pre class="cython line score-30" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">173</span>:     def skip_double(self) -&gt; None:</pre>
<pre class='cython code score-30 '>/* Python wrapper */
...
/* … */
  ...
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 173, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_33skip_double, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_double, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[14]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 173, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_double, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 173, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">174</span>:         self._current += 8</pre>
...
<pre class="cython line score-30" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">176</span>:     def skip_bytes(self) -&gt; None:</pre>
<pre class='cython code score-30 '>/* Python wrapper */
...
/* … */
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(1);<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 176, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_4, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 176, __pyx_L1_error)</span>
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_35skip_bytes, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_bytes, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[15]));<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 176, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_3, __pyx_t_4);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_bytes, __pyx_t_3) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 176, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
</pre><pre class="cython line score-0">&#xA0;<span class="">177</span>:         cdef uint64_t result;</pre>
<pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">178</span>:         decode_zigzag_ints(&amp;self._current, 1, &amp;result)</pre>
<pre class='cython code score-0 '>  decode_zigzag_ints((&amp;__pyx_v_self-&gt;_current), 1, (&amp;__pyx_v_result));
</pre><pre class="cython line score-0" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">179</span>:         self._current += result</pre>
...
<pre class="cython line score-34" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">181</span>:     def skip_utf8(self) -&gt; None:</pre>
...
/* … */
  __pyx_t_3 = <span class='pyx_c_api'>__Pyx_PyDict_NewPresized</span>(1);<span class='error_goto'> if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 181, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_3);
  if (<span class='py_c_api'>PyDict_SetItem</span>(__pyx_t_3, __pyx_mstate_global-&gt;__pyx_n_u_return, __pyx_mstate_global-&gt;__pyx_n_u_None) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 181, __pyx_L1_error)</span>
  __pyx_t_4 = <span class='pyx_c_api'>__Pyx_CyFunction_New</span>(&amp;__pyx_mdef_9pyiceberg_4avro_12decoder_fast_19CythonBinaryDecoder_37skip_utf8, __Pyx_CYFUNCTION_CCLASS, __pyx_mstate_global-&gt;__pyx_n_u_CythonBinaryDecoder_skip_utf8, NULL, __pyx_mstate_global-&gt;__pyx_n_u_pyiceberg_avro_decoder_fast, __pyx_mstate_global-&gt;__pyx_d, ((PyObject *)__pyx_mstate_global-&gt;__pyx_codeobj_tab[16]));<span class='error_goto'> if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 181, __pyx_L1_error)</span>
  <span class='refnanny'>__Pyx_GOTREF</span>(__pyx_t_4);
  <span class='pyx_c_api'>__Pyx_CyFunction_SetAnnotationsDict</span>(__pyx_t_4, __pyx_t_3);
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_3); __pyx_t_3 = 0;
  if (<span class='pyx_c_api'>__Pyx_SetItemOnTypeDict</span>(__pyx_mstate_global-&gt;__pyx_ptype_9pyiceberg_4avro_12decoder_fast_CythonBinaryDecoder, __pyx_mstate_global-&gt;__pyx_n_u_skip_utf8, __pyx_t_4) &lt; (0)) <span class='error_goto'>__PYX_ERR(0, 181, __pyx_L1_error)</span>
  <span class='pyx_macro_api'>__Pyx_DECREF</span>(__pyx_t_4); __pyx_t_4 = 0;
</pre><pre class="cython line score-5" onclick="(function(s){s.display=s.display==='block'?'none':'block'})(this.nextElementSibling.style)">+<span class="">182</span>:         self.skip_bytes()</pre>
